...
from app.services.bettertranslation_service import get_bettertranslation, insert_tagintotranslation
...
async def insert_tag_into_translation(data: BetterTranslationRequest):
    output = insert_tagintotranslation(data.instruction, data.input)
    return {
